...
def load_data():
    ...
    gal_data=fits.getdata(source_dir + full_sample,1)
   
    bins=np.load(source_dir + "assignments.npy") # Voronoi bin data from the voronoi fitting. 
    ...
    flag=np.zeros((n_morph,len(gal_tb.T))) # Empty array
